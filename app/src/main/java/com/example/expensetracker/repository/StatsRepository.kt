...
class StatsRepository(
    ...
    suspend fun getDailyTotals(startDate: String, endDate: String, categoryPath: String? = null): List<DailyTotal> =
        statsDao.getDailyTotals(startDate, endDate, categoryPath)
